...
<div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="mt-6 text-xl font-black text-stone-900 uppercase tracking-wide">Créer un compte</h2>
            <div class="h-1 w-12 bg-[#b91c1c] mx-auto rounded-full mt-2"></div>
            <p class="text-xs text-stone-400 mt-3">Rejoignez la communauté et interagissez avec les articles</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                {{-- Nom --}}
                <div class="space-y-2">
                    <label class="text-xs font-bold uppercase text-stone-500 tracking-wider">Nom complet</label>
